...
], CatResolver.prototype, "hello", null);
__decorate([
    graphql_1.Query(() => [cat_dto_1.catType]),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CatResolver.prototype, "findcat", null);
__decorate([
    graphql_1.Mutation(() => cat_dto_1.catType),
    __param(0, graphql_1.Args('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [cat_dto_1.catInput]),
    __metadata("design:returntype", Promise)
], CatResolver.prototype, "createCats", null);
__decorate([
    graphql_1.Mutation(() => cat_dto_1.catType),
    __param(0, graphql_1.Args('input')),
    __metadata("design:type", Function),
...
__decorate([
    graphql_1.Mutation(() => cat_dto_1.catType),
    __param(0, graphql_1.Args('id')),
    __param(1, graphql_1.Args('cat')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, cat_dto_1.catInput]),
    __metadata("design:returntype", Promise)
